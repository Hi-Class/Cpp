...
struct HardwareMapping matrix_hardware_mappings[] = {
...

  {
    ...
    .c             = GPIO_BIT(4),
    .d             = GPIO_BIT(4),
    .e             = GPIO_BIT(4),  /* RxD kept free unless 1:64 */

    /* Parallel chain 0, RGB for both sub-panels */
    .p0_r1         = GPIO_BIT(14),  /* masks: SPI0_SCKL  */
    .p0_g1         = GPIO_BIT(15),  /* Not on RPi1, Rev1; use "regular-pi1" instead */
    .p0_b1         = GPIO_BIT(23),   /* masks: SPI0_CE1   */
    .p0_r2         = GPIO_BIT(24),   /* masks: SPI0_CE0   */
    .p0_g2         = GPIO_BIT(25),   /* masks: SPI0_MISO  */
    .p0_b2         = GPIO_BIT(8),  /* masks: SPI0_MOSI  */
    ...
    /* Chain 2 */
    .p2_r1         = GPIO_BIT(14), /* masks TxD when parallel=3 */
    .p2_g1         = GPIO_BIT(15),  /* masks SCL when parallel=3 */
    .p2_b1         = GPIO_BIT(23),  /* masks SDA when parallel=3 */
    .p2_r2         = GPIO_BIT(24),
    .p2_g2         = GPIO_BIT(25),
    .p2_b2         = GPIO_BIT(8),
  },
